...
public class Conjunto<X> implements Cloneable
{
    ...
    public void remova (X x) throws Exception
    {
        ...
        if (this.elem.length>this.capInicial &&
            this.qtd<=((int)(0.25*this.elem.length)))
    ...
    public boolean contem (Conjunto<X> conj) throws Exception
    {
		...
		for (int i=0; i<this.qtd; i++)
		    if (this.ondeEsta((X)conj.elem[i])==-1)
		        return false;
    ...
    public boolean equals (Object obj)
    {
		...
		if (this.capInicial!=conj.capInicial) return false;
    ...
    public int hashCode ()
    {
		...
		ret = 13*ret + ((Integer)this.capInicial).hashCode();
